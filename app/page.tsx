      ...
      <main>
        ...
        <section className="w-full h-screen overflow-hidden flex flex-col items-center justify-center relative bg-white">
          <Floating sensitivity={-0.5} className="h-full pointer-events-none">
            <FloatingElement depth={0.5} className="hidden md:block top-[20%] left-[4%]">
              <motion.img
                src={portfolioImages[0].src}
                alt={portfolioImages[0].alt}
                className="w-28 h-20 md:w-32 md:h-24 object-cover pointer-events-auto hover:scale-105 duration-200 cursor-pointer transition-transform -rotate-[3deg] shadow-2xl rounded-xl"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <FloatingElement depth={4} className="hidden md:block top-[72%] left-[7%]">
              <motion.img
                src={portfolioImages[2].src}
                alt={portfolioImages[2].alt}
                className="w-48 h-48 md:w-56 md:h-56 object-cover -rotate-[4deg] pointer-events-auto hover:scale-105 duration-200 cursor-pointer transition-transform shadow-2xl rounded-xl"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <FloatingElement depth={1} className="hidden md:block top-[65%] left-[81%]">
              <motion.img
                src={portfolioImages[4].src}
                alt={portfolioImages[4].alt}
                className="w-56 h-56 md:w-64 md:h-64 object-cover pointer-events-auto hover:scale-105 duration-200 cursor-pointer transition-transform shadow-2xl rotate-[10deg] rounded-xl"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
          ...
          <div className="flex flex-col justify-center items-center w-[260px] sm:w-[340px] md:w-[540px] lg:w-[720px] z-10 pointer-events-auto text-center">
            <motion.p
