...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: "oug-website",
    name: "OUG.mn Website",
    tagline: "From Structure to Experience.",
    taglineMn: "Бүтцээс хэрэглэгчийн туршлага руу.",
    ...
    description:
      "Building upon an existing wireframe structure, the project focused on translating the defined layouts into a cohesive high-fidelity interface and interactive digital experience. The design process explored visual hierarchy, typography, color, and interface details to establish a refined and consistent website experience. Interactive prototypes were developed to communicate navigation and user flows, providing a clear reference for development. The final designs were handed off to the development team and successfully implemented as a live website.",
    descriptionMn:
      "Төслийн бэлэн wireframe бүтцэд үндэслэн тодорхойлогдсон зохиомжийг өндөр нарийвчлалтай визуал интерфейс болон интерактив дижитал туршлага болгон хөгжүүлэхэд анхаарсан. Дизайны явцад визуал шатлал, типографик, өнгө болон интерфейсийн нарийн элементүүдийг боловсруулж, нэгдмэл бөгөөд цэгцтэй вэбсайтын туршлагыг бүрдүүлсэн. Хэрэглэгчийн навигаци болон үндсэн үйлдлүүдийг илэрхийлэх интерактив prototype боловсруулж, хөгжүүлэлтийн багт ойлгомжтой загвар, чиглэл өгсөн. Эцсийн дизайныг хөгжүүлэгчдэд хүлээлгэн өгсний дараа бодит вэбсайт болгон амжилттай хэрэгжүүлсэн.",
    cover: "/projects/oug/1.webp",
    images: [
      "/projects/oug/1.webp",
      "/projects/oug/2.webp",
      "/projects/oug/3.webp",
    ...
    galleryLayout: [
      { type: "pair-natural", images: ["/projects/oug/2.webp"] },
      { type: "pair-natural", images: ["/projects/oug/3.webp"] },
      { type: "pair-natural", images: ["/projects/oug/4.webp"] },
      { type: "pair-natural", images: ["/projects/oug/5.webp", "/projects/oug/6.webp"] },
    ],
    featured: true,
  },
]
