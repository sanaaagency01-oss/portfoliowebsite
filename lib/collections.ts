  ...
  // ─── TYPOGRAPHY ───────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        client: "Personal",
        description: "A curated series of typographic explorations drawing from Mongolian visual culture and contemporary design language.",
    ...
    items: [
      {
        ...
        descriptionMn: "Үсгийн хэлбэр, зохион байгуулалт, харааны иерархийг судалсан типографи постерийн цуврал.",
        year: "2025",
      ...
      },
      {
        ...
        descriptionMn: "Монголын Цагаан Сарыг тэмдэглэсэн постер цуврал — уламжлалт хээ дизайны орчин үеийн хэлтэй нийлсэн зоримог бүрдэл.",
        year: "2025",
      ...
      },
      {
        ...
        descriptionMn: "Бьютитек салоны зар сурталчилгааны постер цуврал — цэвэрхэн, эмэгтэйлэг бүрдэл, типографи аксент.",
        year: "2025",
      ...
      },
      {
        ...
        descriptionMn: "Алтан Хулгана брэндийн эдиториал постер цуврал.",
        year: "2025",
      ...
      },
      {
        ...
        descriptionMn: "Зоримог, хөдөлгөөнт бүрдэл бүхий график постер цуврал.",
        year: "2025",
      ...
      },
      {
        ...
        descriptionMn: "Нуугдмал замаас санаа авсан уур амьсгалтай, бүдэг-бадаг текстуртай постер цуврал.",
        year: "2025",
        images: [
      ...
      },
      {
        ...
        descriptionMn: "Марал кофе шопын брэнд постер цуврал — дулаан өнгө, гар хийцийн мэдрэмж.",
        year: "2025",
        images: [
      ...
      },
      {
        ...
        descriptionMn: "Спортын сэдэвтэй динамик постер дизайнууд — эрч хүчтэй бүрдэл.",
        year: "2025",
        images: [
      ...
      },
      {
        ...
        descriptionMn: "Хүний дүрс бүхий постер бүтээлийн хувийн цуврал — илэрхийлэлтэй, хүний мэдрэмж.",
        year: "2025",
      ...
      },
      {
        ...
        descriptionMn: "Өгөгдлийн харааллыг цэвэрхэн график хэлтэй хослуулсан мэдээлэл дизайны постерууд.",
        year: "2025",
        images: [
      ...
      },
      {
        ...
        descriptionMn: "Янз бүрийн сэдэв, хэв маяг, харааны туршилтыг хамарсан холимог график дизайны постерийн цуврал.",
        year: "2024–2025",
    ...
    items: [
      {
        ...
        descriptionMn: "Старбабл МН бол тоглоомлог, дугуй хэлбэртэй монгол дисплей фонт — илэрхийлэлтэй, онцлог дүр төрхтэй.",
        year: "2025",
      ...
      },
      {
        ...
        descriptionMn: "Хан Сериф бол монгол соёлын нөлөөтэй, элэгдэлтэй сериф фонт. Нарийн зураасан, сонгодог пропорцтой.",
        year: "2025",
        images: [
          `${FC}/Khan serif.webp`,
